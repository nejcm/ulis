// handleTuiKey: navigation across every screen, preset picking, the custom-source text editor,
// key-alias normalization, and the rapid-repeat dedupe window (Date.now stubbed per test).
