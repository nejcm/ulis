...
- **Unmanaged Entry**: An existing destination agent or skill entry that was not generated by the current ULIS install. Install leaves unmanaged entries in place unless a generated agent or skill has the same native name.
